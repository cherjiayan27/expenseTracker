...
import { useAddSubscriptionForm } from "../../hooks/add/useAddSubscriptionForm";
import { useSubscriptionMutations } from "../../actions/useSubscriptionMutations";
import type { SubscriptionPeriod } from "../../domain/subscription.types";
...
export function AddSubscriptionModal({ isOpen, onClose, onSuccess, onError }: AddSubscriptionModalProps) {
  ...
  const {
    ...
    resetForm,
    isValid,
  } = useAddSubscriptionForm();

  const { create, isPending } = useSubscriptionMutations();
